...
Script Purpose:
      ...
      populate the 'silver' schema tables from the 'brnze' schema.
  Actions Performed :
...
BEGIN
	DECLARE @start_time DATETIME, @end_time DATETIME,@batch_start_time DATETIME, @batch_end_time DATETIME;
		...
		SET @batch_start_time = GETDATE();
			...
			PRINT('>> Inserting data into : silver.crm_cusr_info');
			...
			SELECT
				...
				CASE
					...
					ELSE 'n/a'
				END cst_marital_status,  -- Normalise marital status valuesto readable format
			...
			PRINT('>> Inersting data into : silver.crm_prd_info');
			...
			SELECT
				...
				CAST(
					...
					AS DATE
				) AS pd_end_dt -- calculate end date as one day before the next start date 
			...
			SET @end_time = GETDATE();
			PRINT'>> Load Duration :' + DATEDIFF(second , @start_time, @end_time) + 'seconds';
